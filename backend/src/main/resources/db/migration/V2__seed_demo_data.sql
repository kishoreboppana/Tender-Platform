...
INSERT INTO tms.tender (
    ...
    status, priority, health, completion_percent, latest_status_comment
)
VALUES
    (
        'a0000000-0000-4000-8000-000000000001',
...
VALUES
    ('a0000000-0000-4000-8000-000000000001', 'SCHEMA_INITIALIZED', 'DATABASE', 'tms', 'flyway', 'Initial TMS schema and demo seed applied'),
